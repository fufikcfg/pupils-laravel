...
@section('forms')
    <ul class="list-group">
       ...
       <li class="list-group-item">Учится в {{ $itemLittle['classes']['level_study'] }} {{ $itemLittle['classes']['classes_letter'] }} классе</li>
       @endforeach
    </ul>
    <div><br></div>
    <ul class="list-group">
    ...
    <table class="table">
        ...
        @foreach($bornInJuly as $bornItem)
            <tr>
                ...
                <td>{{ $bornItem['classes']['level_study'] }} {{ $bornItem['classes']['classes_letter'] }}</td>
            </tr>
        @endforeach
        </thead>
    </table>
